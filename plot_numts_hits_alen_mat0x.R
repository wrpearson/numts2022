...
################
## used to plot Suppl Figure 2

################
## like plot_numts_alen_mat0.R, but uses export EXCLUDE_TAXA=bad_taxa.tab to exclude some taxa

################
## plot_numts_alen_mat0x .R -- plot box plots of all data by matrix and coverage -- .tab files in data/, results in figs/
##
################
##
...
p.name<-'plot_numts_hits_alen_mat0.R'
